<?php
// ✅ DEBUGGING ENABLED (temporarily)
error_reporting(E_ALL);
ini_set('display_errors', 0); // set to 1 to debug locally, 0 in production
...
try {
    ...
    // 🗑 Delete old PurchaseOrder items
    ...
    // ➕ Insert updated PurchaseOrder items
