    ...
    try {
      if (reportType === "sales" || reportType === "all") {
        const res = await fetch(
          buildUrl(
            "http://13.239.143.31/DeliveryTrackingSystem/get_sales_report.php"
          )
        );
      ...
      if (reportType === "transaction" || reportType === "all") {
        const res = await fetch(
          buildUrl(
            "http://13.239.143.31/DeliveryTrackingSystem/get_transaction_report.php"
          )
        );
      ...
      if (
        ...
        const res = await fetch(
          buildUrl(
            "http://13.239.143.31/DeliveryTrackingSystem/get_service_delivery_report.php"
          )
        );
      ...
      if (reportType === "customer" || reportType === "all") {
        const res = await fetch(
          buildUrl(
            "http://13.239.143.31/DeliveryTrackingSystem/get_customer_satisfaction_report.php"
          )
        );
