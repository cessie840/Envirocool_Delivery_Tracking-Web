        ...
        .then((response) => {
          ...
          if (data.success) {
            ...
            const profilePicUrl = user.pers_profile_pic
              ? `https://delivery-api.mooo.info//DeliveryTrackingSystem/uploads/personnel_profile_pic/${user.pers_profile_pic}`
              : `https://delivery-api.mooo.info//DeliveryTrackingSystem/default-profile-pic.png`;
