  ...
  return (
    <div className="login-container">
      <div className="login-card text-center">
       ...
       {/* Step 3: Reset Password */}
{step === 3 && (
  <form className="login-form text-start" onSubmit={handleChangePassword}>
    {/* New Password Field */}
        ...
        <input
          ...
          onChange={(e) => {
            ...
            setValidation({
              ...
              number: /\d/.test(value),
              special: /[^A-Za-z0-9]/.test(value), // ✅ accepts all special characters
            });
          }}
          required
        />
    ...
    <div className="mt-2" style={{ fontSize: "0.8rem", marginBottom: "8px" }}>
      <p
        style={{
    ...
    <button
      ...
      className="btn login-btn w-100 rounded-3 fs-5 p-2"
      onClick={(e) => {
        // client-side error validation before submit
        if (newPassword !== confirmPassword) {
          e.preventDefault();
          setErrorMessage("Passwords do not match.");
          return;
