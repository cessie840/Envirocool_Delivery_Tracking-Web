...
import { Row, Col, Card, Modal, Collapse, Button } from "react-bootstrap";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://delivery-api.mooo.info/DeliveryTrackingSystem/get_total_dashboard.php",
        {
    ...
    axios
      .get(
        "https://delivery-api.mooo.info/DeliveryTrackingSystem/get_recent_transactions.php",
        {
          withCredentials: true,
        }
      )
    ...
    axios
      .get(
        "https://delivery-api.mooo.info/DeliveryTrackingSystem/get_pending_transactions.php",
        {
          withCredentials: true,
        }
      )
    ...
    axios
      .get(
        "https://delivery-api.mooo.info/DeliveryTrackingSystem/get_yearly_distribution.php",
        {
          withCredentials: true,
        }
      )
    ...
    axios
      .get(
        "https://delivery-api.mooo.info/DeliveryTrackingSystem/get_monthly_transactions.php",
        {
          withCredentials: true,
        }
      )
